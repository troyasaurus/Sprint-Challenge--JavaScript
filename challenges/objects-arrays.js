...
console.log("The T-rex goes", tyrannosaurus.roar());
...
const lowCaseAnimalNames = zooAnimals.map(function(smallNames){
  return smallNames.animal_name.toLowerCase();
})
...
*/
const populationTotal = zooAnimals.reduce(function(totalPop, things){
  return totalPop + things.population;
}, 0);
